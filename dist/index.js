...
export default defineExtension({
    activate(api) {
        api.registerCommand({
            name: "oss-setup",
            description: "Apply the open-source pm preset: writes settings.json and installs contributor-friendly templates.",
            flags: [
                {
                    long: "force",
                    short: "f",
                ...
                },
                {
                    ...
                    short: "p",
                    type: "string",
                    description: "Override the id_prefix written to settings.json (default: oss-).",
                },
            ],
            async run(context) {
